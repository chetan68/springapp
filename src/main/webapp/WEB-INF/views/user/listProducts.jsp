			...
			<div class="container" style="margin-top: 4%" ng-app="tabApp"
				...
				<div class="row">
					...
					<div class="col-xs-4">
						...
						<a href="<c:url value='/ulp1?cat=uall'/>" class="btn btn-info" role="button">Show All</a>
					</div>
				</div>
			</div>
		</form>
				...
				<table class="table table-bordered">
					...
					<tbody>
						<tr ng-repeat="x in data">
							...
							<td>{{x.Warranty}}</td>
							<td>{{x.Category}}</td>
							<td><a href="<c:url value='/uview?id={{x.id}}'/>" class="btn btn-info" role="button">Details</a></td>
						</tr>
					</tbody>
				</table>
