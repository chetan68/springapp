		...
		<table width="70%" align="center" border="0">
			<tr>
				<td><img src=${viewrow.getImgPath()
					...
					alt=${viewrow.getCategory() } width="300px" height="300px" /></td>
				<td>&nbsp;</td>
				<td><h3>
			...
			<tr>
				<td colspan="3" align="center"> 
					<a href="<c:url value='/ulp1?cat=u${viewrow.getCategory()}'/>" class="btn btn-info" role="button">Back</a> 
					&nbsp;&nbsp; 
					<a href="<c:url value='/addtocart?id=${viewrow.getId()}'/>" class="btn btn-info" role="button">Add To Cart</a>
				</td>
			</tr>
		</table>
	</div>
